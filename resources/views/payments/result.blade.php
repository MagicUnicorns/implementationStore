...
<div class="status-container">
  <div class="status">
    ...
    <img src="/svg/failed.svg" class="status-image" alt="failed">
    @else
    <img src="/svg/success.svg" class="status-image" alt="success">
    <img src="/svg/thank-you.svg" class="status-image status-image-thank-you" alt="thank you">
    @endif
    ...
    <a class="button" href="/home" to="#/">Return Home</a>
  </div>
</div>
