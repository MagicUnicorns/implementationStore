            ...
            <div class="card-body">
                <form action="{{ route('patients.update', $patient->id) }}" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ $patient->name }}">
                            @if ($errors->has('name'))
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <select class="form-select" aria-label="Default select example" name="gender" id="gender">
                                <option {{ $patient->gender == 'unknown' ? 'selected' : '' }} value="unknown">unknown</option>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <textarea type="text" class="form-control @error('notes') is-invalid @enderror" id="notes" name="notes"  value="{{ $patient->notes }}"></textarea>
                            @if ($errors->has('notes'))
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <textarea type="text" class="form-control @error('medical_history_summary') is-invalid @enderror" id="medical_history_summary" name="medical_history_summary"  value="{{ $patient->medical_history_summary }}"></textarea>
                    ...
                    <div class="mb-3 row">
                        <input type="submit" class="col-md-3 offset-md-5 btn btn-primary" value="Change Patient">
                    </div>
