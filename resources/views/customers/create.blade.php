            ...
            <div class="card-body">
                <form action="{{ route('customers.store') }}" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                        <!-- <input type="text" class="form-control @error('preferred_contact_method') is-invalid @enderror" id="preferred_contact_method" name="preferred_contact_method" value="{{ old('preferred_contact_method') }}"> -->
                            <select class="form-select" aria-label="Default select example" name="preferred_contact_method" id="preferred_contact_method">
                                <option {{ old('preferred_contact_method') == 'phone' ? 'selected' : '' }} value="phone">phone</option>
                                <option {{ old('preferred_contact_method') == 'mail' ? 'selected' : '' }} value="mail">mail</option>
                                <option {{ old('preferred_contact_method') == 'text' ? 'selected' : '' }} value="text">text</option>
                            </select>
