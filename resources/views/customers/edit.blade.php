            ...
            <div class="card-body">
                <form action="{{ route('customers.store') }}" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('title_pre') is-invalid @enderror" id="title_pre" name="title_pre" value="{{ old('title_pre') }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('title_mid') is-invalid @enderror" id="title_mid" name="title_mid" value="{{ old('title_mid') }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('title_post') is-invalid @enderror" id="title_post" name="title_post" value="{{ old('title_post') }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('secondary_phone') is-invalid @enderror" id="secondary_phone" name="secondary_phone">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('address_line1') is-invalid @enderror" id="address_line1" name="address_line1">
                    ...
                    <div class="mb-3 row">
                        <label for="address_line2" class="col-md-4 col-form-label text-md-end text-start">Telefonnummer</label>
                        <div class="col-md-6">
                          <input type="text" class="form-control @error('address_line2') is-invalid @enderror" id="address_line2" name="address_line2">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                        <input type="text" class="form-control @error('preferred_contact_method') is-invalid @enderror" id="preferred_contact_method" name="preferred_contact_method">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                        <input type="text" class="form-control @error('emergency_contact_phone') is-invalid @enderror" id="emergency_contact_phone" name="emergency_contact_phone">
